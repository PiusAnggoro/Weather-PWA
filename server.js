...
const API_KEY = process.env.b5f1e2588924f8807dc1bec0b5f3405f;
...
function generateFakeForecast(location) {
  location = location || '-7.7927441,110.408355';
...
function getForecast(req, resp) {
  const location = req.params.location || '-7.7927441,110.408355';
